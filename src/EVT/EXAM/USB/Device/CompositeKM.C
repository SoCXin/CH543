...
/* 端点1 IN缓冲区,必须是偶地址 */
UINT8X  Ep1Buffer[ MIN( 64, ENDP1_IN_SIZE ) ] _at_ MIN( 64, THIS_ENDP0_SIZE + 2 );
/* 端点2 IN缓冲区,必须是偶地址 */
UINT8X  Ep2Buffer[ MIN( 64, ENDP2_IN_SIZE ) ] _at_ ( MIN( 64, THIS_ENDP0_SIZE + 2 ) + MIN( 64, ENDP1_IN_SIZE + 2 ) );
